...
class HAHIHeteroNeck(BaseModule):
    ...
    """
# neck_cfg = {'type': 'HAHIHeteroNeck', 'positional_encoding': {'type': 'SinePositionalEncoding', 'num_feats': 256}, 'in_channels': [64, 192, 384, 768, 1536], 'out_channels': [64, 192, 384, 768, 1536], 'embedding_dim': 512, 'scales': [1, 1, 1, 1, 1]}
    def __init__(self,
        ...
        self.trans_positional_encoding = SinePositionalEncoding(num_feats=256)
        self.conv_positional_encoding = SinePositionalEncoding(num_feats=256)
