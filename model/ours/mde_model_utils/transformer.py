...
# from depth.models.utils.builder import TRANSFORMER
...
#     """
#     transformer that only includes an multi-scale decoder
#     """

#     def __init__(self, decoder=None, init_cfg=None):
#         super(PixelMSDeTransformer, self).__init__(init_cfg=init_cfg)
#         self.decoder = build_transformer_layer_sequence(decoder)
...
#     def forward(self, ms_feats, query_embed, pos_embed, mask_feat):
#         """Forward function for `PureMSDeTransformer`.
#         Args:
#             x (Tensor): Input query with shape [bs, c, h, w] where
#                 c = embed_dims.
#             mask (Tensor): The key_padding_mask used for encoder and decoder,
...
#         return self.decoder(ms_feats, query_embed, pos_embed, mask_feat)
