...
# VOID - Ours
# Test
python test_multiDataLoader.py --data_name VOID --void_sparsity 150 --dir_data /workspace/logs/void_data --gpus 1 --model_name depth_prompt_main --pretrain ./pretrained/OURS/weight_231025_192858.pth.tar --prop_kernel 9 --conf_prop --prop_time 18 --patch_height 240 --patch_width 320 --init_scailing

-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

# SUNRGBD - Ours
# Test
python test_multiDataLoader.py --data_name SUNRGBD --dir_data /workspace/data/SUNRGBD --gpus 1 --model_name depth_prompt_main --pretrain ./pretrained/OURS/weight_231025_192858.pth.tar --prop_kernel 9 --conf_prop --prop_time 18 --patch_height 240 --patch_width 320 --init_scailing --use_raw_depth_as_input

-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

# IPAD - Ours
# Test
python test_multiDataLoader.py --data_name IPAD --dir_data /workspace/logs/ipad_dataset/selected/ --save_dir /workspace/logs/visualization/IPAD-Comparison/_cvpr_submission --model_name depth_prompt_main --pretrain ./pretrained/OURS/weight_231025_192858.pth.tar --gpu 0 --nyu_val_samples 0,1,5 --patch_height 228 --patch_width 304 --conf_select -v

-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

# nuScenes - Ours
# Test
python test_multiDataLoader.py --data_name NUSCENE --dir_data /workspace/data/nuscene --save_dir /workspace/logs/visualization/NUSCENE-Comparison/_cvpr_submission --gpu 0 --model_name depth_prompt_main --pretrain ./pretrained/OURS/kitti_depth_prompt_main.tar  --top_crop 0 --kitti_val_lidars 64 --prop_kernel 9 --prop_time 18 --conf_prop --init_scailing -v 
